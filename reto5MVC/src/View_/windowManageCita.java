...
public class windowManageCita implements ActionListener {
    ...
    private JLabel lblNombreMascota = new JLabel("Nombre de mascota");
    private JLabel lblPropUsuario = new JLabel("Usuario del propietario");
    private JLabel lblCitaDescripcion = new JLabel("Descripcion de Cita");
    private JLabel lblCitaFecha = new JLabel("Fecha de Cita");
    ...
    private void configFrame() {
        ...
        this.frame.setTitle("Cita Management");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == this.btnUpdate) {
            ...
            String nombre = (String) this.txtMascota.getText();
            String usuario = (String) this.txtPropUsuario.getText();
            String descripcion = (String) this.txtDescripcion.getText();
            String fecha = (String) this.txtFecha.getText();

            citDAO.actualizarCita(nombre, usuario, fecha, descripcion);
        }
        
        /*
            Este condicional escucha al boton encargado de la eliminacion de datos de 
            citas, en donde se usa el dato de nombre de mascota y usuario de propietario
        ...
        if (ae.getSource() == this.btnDelete) {
            ...
            citDAO.eliminarCita(nombre, usuario);
        }
        
         /*
            Este ultimo condicional escucha al boton crear, lo cual genera una ventana diferente
            con campos diferentes disponibles para la creacion de una cita
         */
        if (ae.getSource() == this.btnCreate) {
            windowCreateCita createCita = new windowCreateCita();
        }
    }
}
